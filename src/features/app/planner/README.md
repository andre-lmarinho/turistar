...
- [Planner realtime collaboration](../../docs/p/realtime-collaboration.md) – event payloads, Supabase channel lifecycle, and optimistic workflow details.
- `src/features/app/planner/hooks/usePlanCollaboration.ts` – React hook that exposes the live plan state, optimistic mutations, and persistence helpers.
- `src/features/app/planner/services/supabase/planEventsRepository.ts` – Supabase data access layer with Zod validation and realtime subscriptions.
