...
export const clientEnv = clientEnvSchema.parse({
  ...
  NEXT_PUBLIC_SUPABASE_URL:
    process.env.NEXT_PUBLIC_SUPABASE_URL ?? (IN_CI ? FALLBACKS.NEXT_PUBLIC_SUPABASE_URL : undefined),
  NEXT_PUBLIC_SUPABASE_ANON_KEY:
    process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ??
    (IN_CI ? FALLBACKS.NEXT_PUBLIC_SUPABASE_ANON_KEY : undefined),
  NEXT_PUBLIC_GEOAPIFY_KEY:
    process.env.NEXT_PUBLIC_GEOAPIFY_KEY ?? (IN_CI ? FALLBACKS.NEXT_PUBLIC_GEOAPIFY_KEY : undefined),
});
