...
const buttonVariants = cva(
  'focus-visible:ring-primary/60 inline-flex h-8 items-center justify-center rounded-md px-3 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:outline-none',
  {
    variants: {
      variant: {
