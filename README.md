...
7. Follow the commit message style: start with an appropriate Gitmoji and conventional type (e.g., `✨ feat:`) followed by a short, imperative description in English. Commitlint enforces this format.
