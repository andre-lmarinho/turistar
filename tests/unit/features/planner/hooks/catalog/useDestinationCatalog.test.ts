// tests/unit/features/planner/hooks/catalog/useDestinationCatalog.test.ts

import { renderHook } from '@testing-library/react';

vi.mock('@/features/planner/hooks/catalog/useCatalogActivities', () => ({
  useCatalogActivities: vi.fn(),
}));

import { useCatalogActivities } from '@/features/planner/hooks/catalog/useCatalogActivities';
import { useDestinationCatalog } from '@/features/planner/hooks/catalog/useDestinationCatalog';
