// tests/unit/features/planner/hooks/catalog/useGeoapifySearch.test.ts

import React from 'react';
import { renderHook, waitFor } from '@testing-library/react';
import { QueryClient, QueryClientProvider } from '@tanstack/react-query';

vi.mock('@/features/planner/hooks/catalog/fetchSearch', () => ({
  fetchSearch: vi.fn(),
}));
import { fetchSearch } from '@/features/planner/hooks/catalog/fetchSearch';
import { useGeoapifySearch } from '@/features/planner/hooks/catalog/useGeoapifySearch';
