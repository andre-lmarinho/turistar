...
describe('fetchWikimediaSignals', () => {
  ...
  it('rejects images of robots or animals', async () => {
    const titleResp = {
      query: {
        pages: {
          1: {
            pageid: 1,
            title: 'Foo',
            thumbnail: { source: 'robot.jpg', width: 400, height: 300 },
          },
        },
      },
    };
  ...
  it('rejects images of planes', async () => {
    const titleResp = {
      query: {
        pages: {
          1: {
            pageid: 1,
            title: 'Foo',
            thumbnail: { source: 'plane.jpg', width: 400, height: 300 },
          },
        },
      },
    };
