-- Fix security issue: use auth.uid() instead of trusting client-supplied user_id
...
GRANT EXECUTE ON FUNCTION get_user_planners() TO authenticated;

-- Drop the old vulnerable function
DROP FUNCTION IF EXISTS get_user_planners(uuid);
